...
test("includes linked savings lifecycle, settlement, and action reminders", async () => {
  ...
  assert.match(page, /buildDailySavingsTrend\(savings, rangeStartDate, today\)/);
  ...
  assert.match(page, /1 tuần/);
  assert.match(page, /1 tháng/);
  assert.match(page, /6 tháng/);
  assert.match(page, /1 năm/);
  assert.match(page, /Tất cả/);
  assert.match(page, /function changeZoom/);
  assert.match(page, /type="range"/);
  assert.match(page, /Ctrl \+ con lăn/);
